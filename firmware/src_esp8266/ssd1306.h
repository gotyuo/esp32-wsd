#pragma once
// ============================================================
// 0.96" I2C OLED (SSD1306 / SSD1315 兼容) 128x64 驱动 - ESP8266
// 4 孔: VSS=GND, VDD=3V3, SCL=D1(GPIO5), SDA=D2(GPIO4)
// 地址 0x3C,与 AHT20(0x38)/BMP280(0x76) 并联,不冲突
...
public:
    ...
    bool begin(uint8_t scl = 5, uint8_t sda = 4, uint8_t addr = OLED_ADDR);
